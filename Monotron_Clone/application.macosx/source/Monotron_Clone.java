...
public class Monotron_Clone extends PApplet {
...
public void setup(){
  ...
  Function frequencyModulation = new Function(LFO){
    ...
    return (x[0]*200.0f*lInt.getValue()*sel)+ mtof[MIDInote];
    }
  };
  ...
  Function cutoffModulation = new Function(cutLFO){
    ...
    return ((x[0]*5000.0f)*lInt.getValue()*sel+fCut.getValue());
    }
  };
  
  wp1 = new WavePlayer(ac,frequencyModulation,Buffer.SQUARE);
  
  filter1 = new LPRezFilter(ac,cutoffModulation,0.5f);
  
  filter1.addInput(wp1);
    
  g = new Gain(ac,1,0.5f);
...
public void keyPressed(){
  ...
  switch(key){
    ...
    case('2'):lRate.setValue(2.5f);break;
    case('3'):lRate.setValue(5);break;
    case('4'):lRate.setValue(7.5f);break;
    case('5'):lRate.setValue(10);break;
    case('6'):lRate.setValue(12.5f);break;
    case('7'):lRate.setValue(15);break;
    case('8'):lRate.setValue(17.5f);break;
    case('9'):lRate.setValue(20);break;
    case('0'):lRate.setValue(22.5f);break;
    case('-'):lRate.setValue(25);break;
    
    case('q'):lInt.setValue(0);break;
    case('w'):lInt.setValue(0.1f);break;
    case('e'):lInt.setValue(0.2f);break;
    case('r'):lInt.setValue(0.3f);break;
    case('t'):lInt.setValue(0.4f);break;
    case('y'):lInt.setValue(0.5f);break;
    case('u'):lInt.setValue(0.6f);break;
    case('i'):lInt.setValue(0.7f);break;
    case('o'):lInt.setValue(0.8f);break;
    case('p'):lInt.setValue(0.9f);break;
    
    case('a'):fCut.setValue(100);break;
    case('s'):fCut.setValue(1755.56f);break;
    case('d'):fCut.setValue(3411.12f);break;
    case('f'):fCut.setValue(5066.68f);break;
    case('g'):fCut.setValue(6722.24f);break;
    case('h'):fCut.setValue(8377.8f);break;
    case('j'):fCut.setValue(10033.4f);break;
    case('k'):fCut.setValue(11688.9f);break;
    case('l'):fCut.setValue(13344.5f);break;
    case(';'):fCut.setValue(15000);break;
    
    case('z'):fRes.setValue(0);break;
    case('x'):fRes.setValue(0.1f);break;
    case('c'):fRes.setValue(0.2f);break;
    case('v'):fRes.setValue(0.3f);break;
    case('b'):fRes.setValue(0.4f);break;
    case('n'):fRes.setValue(0.5f);break;
    case('m'):fRes.setValue(0.6f);break;
    case(','):fRes.setValue(0.7f);break;
    case('.'):fRes.setValue(0.8f);break;
    case('/'):fRes.setValue(0.9f);break;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Monotron_Clone" };
    if (passedArgs != null) {
